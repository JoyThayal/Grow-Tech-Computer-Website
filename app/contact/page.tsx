...
export const metadata = {
  ...
  description:
    "Get in touch with Grow Tech for computer repair, hardware diagnostics, and cyber cafe services in Barrackpore.",
};
...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-slate-950 to-indigo-950 text-slate-100 flex flex-col justify-between font-sans px-6 md:px-16 lg:px-24 py-10 selection:bg-indigo-500 selection:text-white relative overflow-hidden">
      ...
      {/* Header */}
      <header className="relative z-10 flex items-center justify-between border-b border-slate-800 pb-6 max-w-5xl mx-auto w-full">
        <Link
          href="/"
        ...
        <span className="text-xs font-mono tracking-wider text-slate-300 uppercase bg-slate-900/80 backdrop-blur-md border border-slate-800 shadow-sm px-4 py-1.5 rounded-full">
          Grow Tech · Helpdesk
        </span>
      </header>

      {/* Main Content */}
      <main className="relative z-10 max-w-5xl mx-auto w-full py-12 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-900/70 backdrop-blur-xl border border-slate-800 p-8 rounded-3xl shadow-2xl space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <div className="space-y-3 pt-2">
                ...
                <a
                  ...
                  className="flex items-center justify-between p-4 rounded-2xl bg-slate-800/60 border border-slate-700/60 hover:bg-slate-800 transition group cursor-pointer"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 space-y-2">
                ...
                <p className="text-sm font-medium text-slate-200 leading-relaxed">
                  ...
                  <span className="text-xs text-slate-400 font-normal">
                    (Insert your exact shop address & nearest landmark here)
                  </span>
                </p>
              </div>
              ...
              <div className="space-y-2.5 pt-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3.5 rounded-xl bg-slate-800/60 border border-slate-700/60 text-xs flex items-center gap-2.5 font-medium text-slate-200">
                    <Laptop className="w-4 h-4 text-indigo-400" />
                    <span>PC & Hardware Care</span>
                  </div>
                  <div className="p-3.5 rounded-xl bg-slate-800/60 border border-slate-700/60 text-xs flex items-center gap-2.5 font-medium text-slate-200">
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-slate-800 pt-6 max-w-5xl mx-auto w-full text-center text-xs font-mono text-slate-500">
        GROW TECH COMPUTER · BARRACKPORE CENTER · ALL RIGHTS RESERVED
      </footer>
    </div>
  );
}
